			...
			<table border="1" align="center">
				...
				<tr>
					...
					<td>
						...
						<p id="passwordField"> <input class="btn btn-outline-dark" type="button" id="pw_btn" name="pw_btn" value="암호변경"
				...
				<tr>
					...
					<td>
						...
						<input class="btn btn-outline-dark" type="button" value="닉네임 중복체크" onClick="nickCheck()">
					</td>
				</tr>
				...
				<tr>
					<td colspan="2" align="center">
						<input class="btn btn-outline-dark" type="submit" value="내정보 수정">
						<input class="btn btn-outline-dark" type="reset" value="취소">
						<input class="btn btn-outline-dark" type="button" value="회원탈퇴" onclick="location='${ctxpath}/member/deleteForm.do'">
					</td>
				</tr>
